function [Fluorescence_Sheet, All_Flur_Names] = Investigate_Fluorescence(x_Lower, x_Upper, y_Lower, y_Upper, F_Sampling_Rate, F_Search_Low, F_Search_High, Finalize_Flag)
...
figure(i+1000)
plot(All_Flur_Times(:,i),All_Flur_Pulses_Norm(:,i), 'LineWidth',1.6 )
hold on
...
% box on
% plot(Flur_Time,Flur_Matrix(:,2:end-1))
end
