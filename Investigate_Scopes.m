function [Scope_Sheet Osc_Name_Array] = Investigate_Scopes(x_Lower, x_Upper, y_Lower, y_Upper, show_positive, show_negative, show_delay, osc_sampling_rate, Finalize_Flag)
